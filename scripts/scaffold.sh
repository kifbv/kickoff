...
KICKOFF_REMOTE=$(cd "$KICKOFF_DIR" && git remote get-url origin 2>/dev/null | sed 's|git@github.com:|https://raw.githubusercontent.com/|;s|^https://github.com/|https://raw.githubusercontent.com/|;s|\.git$|/main|') || true
...
echo ""
echo "  2b. (Optional) Create UI designs from scratch in Stitch:"
echo "      Use the /design-create skill in Claude Code"
echo ""
echo "  2c. (Optional) Import existing UI designs from Stitch:"
echo "      Use the /design-sync skill in Claude Code"
echo ""
echo "  2d. (Optional) Design AWS infrastructure:"
